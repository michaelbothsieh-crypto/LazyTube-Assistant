...
from .commands_dispatch import handle_batch, handle_nlm, handle_note, handle_pic, handle_research, handle_slide, handle_threads
...
COMMAND_HANDLERS = {
    ...
    "/threads": lambda ctx: handle_threads(ctx.chat_id, ctx.text),
    # Podcast 指令
