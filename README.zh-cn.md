...
- **🛡️ 强大的网页抗封锁机制**：内置智能路由与多层代理，针对防护严格的论坛或新闻网站，自动调用 Jina Reader 与自建的 Cloudflare Browser Rendering 进行纯文本提取，确保 NotebookLM 总能获得最干净的来源。
...
2. 执行设置助手：
   ...
   ```
   *(Windows 用户？请参阅 [Windows 指南](docs/WINDOWS_GUIDE.md))*
...
特别感谢作者 **[Jacob Ben-David](https://github.com/jacob-bd)** 开发了如此强大的 MCP 协议工具，让 AI 代理能以程式化方式操作 NotebookLM。
